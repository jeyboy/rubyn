...
void DockWidget::registerSearchCallbacks(QObject * target, const char * search_show_signal, const char * search_hide_signal, const char * search_request_slot, const char * search_close_slot, const char * search_prev_result_slot, const char * search_next_result_slot) {
    header -> registerSearchCallbacks(target, search_show_signal, search_hide_signal, search_request_slot, search_close_slot, search_prev_result_slot, search_next_result_slot);
}
