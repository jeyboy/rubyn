...
void ColorPicker::setuplayout() {
    ...
    l -> addWidget(colors_space, 0, 0, 11, 10);
...
//    curr_color_item -> setFixedSize(40, 40);
    ...
    l -> addWidget(hex_label, 2, 12, Qt::AlignRight | Qt::AlignVCenter);

    QComboBox * hex_name = new QComboBox(this);
    hex_name -> setEditable(true);
    l -> addWidget(hex_name, 2, 13, 1, 4);
    ...
    l -> addWidget(rgb_toggle_btn, 3, 13, 1, 3);
    ...
    l -> addWidget(hsv_toggle_btn, 4, 12, 2, 1);
    ...
    l -> addWidget(hsl_toggle_btn, 6, 12, 2, 1);
    ...
    l -> addWidget(cmyk_toggle_btn, 8, 13, 1, 3);
    ...
    l -> addWidget(down_toggle_btn, 10, 12, 1, 6);
