...
class PredefinedRuby : public SingletonPtr<PredefinedRuby> {
    ...
    PredefinedRuby() {
        ...
        keys.insert(QByteArrayLiteral("{"), lex_inline_block_start);
        keys.insert(QByteArrayLiteral("}"), lex_inline_block_end);
        ...
        keys.insert(QByteArrayLiteral("break"), lex_break); // Leaves a block early
        ...
        keys.insert(QByteArrayLiteral("ensure"), lex_ensure); // Starts a section of code that is always run when an exception is raised
        ...
        keys.insert(QByteArrayLiteral("retry"), lex_retry); // Retries an exception block
        ...
        keys.insert(QByteArrayLiteral("ENV"), lex_name_const); // A hash-like object containing the program's environment variables. ENV can be handled as a hash
        keys.insert(QByteArrayLiteral("RUBY_PLATFORM"), lex_name_const); // A string indicating the platform of the Ruby interpreter.
        keys.insert(QByteArrayLiteral("RUBY_RELEASE_DATE"), lex_name_const); // A string indicating the release date of the Ruby interpreter
        keys.insert(QByteArrayLiteral("RUBY_VERSION"), lex_name_const); // A string indicating the version of the Ruby interpreter
        keys.insert(QByteArrayLiteral("STDERR"), lex_name_const); // Standard error output stream. Default value of $stderr
        keys.insert(QByteArrayLiteral("STDIN"), lex_name_const); // Standard input stream. Default value of $stdin
        keys.insert(QByteArrayLiteral("STDOUT"), lex_name_const); // Standard output stream. Default value of $stdout
        keys.insert(QByteArrayLiteral("TOPLEVEL_BINDING"), lex_name_const); // A binding object at Ruby's top level.
