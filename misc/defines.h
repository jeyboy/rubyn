...
#define DefaultStateLexems lex_min = -8, lex_end_line = -7, lex_end_doc = -6, lex_spacing = -5, lex_tab = -4, lex_tabs = -3, lex_blank = -2, lex_blanks = -1, lex_none = 0, lex_error, lex_warning, lex_notice, lex_undefined, lex_ignore, lex_default
