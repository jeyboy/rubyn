...
namespace {
    ...
    class WinWatcher : public QWidget, public Singleton<WinWatcher> {
    ...
    bool WinWatcher::registerPath(qintptr & id, const QString & path, const bool & recursive) {
...
//                                    SHCNE_SERVERDISCONNECT
    ...
    void WinWatcher::unregisterPath(const qintptr & ptr) {
