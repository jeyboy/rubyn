...
QString IDebugInterface::mark(const QString & path, const int & line_num) { return path % '*' % QString::number(line_num); }

IDebugInterface::IDebugInterface() { }
IDebugInterface::~IDebugInterface() { }

bool IDebugInterface::enableBreakpoint(const QString & /*path*/, const int & /*line_num*/, const bool & /*enable*/) { return false; }
